...
# ============================================================
# CONFERENCE_RANKS — only conferences we actually track,
# ranked strictly per the official CORE list provided.
# Conferences not in the official list get "" (no rank shown).
# ============================================================
CONFERENCE_RANKS = {
    # A+ — official list confirmed
